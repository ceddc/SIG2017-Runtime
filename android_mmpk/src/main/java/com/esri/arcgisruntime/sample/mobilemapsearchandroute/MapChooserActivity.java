...
import static com.esri.arcgisruntime.sample.mobilemapsearchandroute.MapPreviewUtils.orderMapPreviews;
...
public class MapChooserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intentExtras != null) {
            mMapPreviews = orderMapPreviews((List<MapPreview>) intentExtras.get("map_previews"));
